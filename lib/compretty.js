...
export class BurstStack {
  ...
  _mainLoop() {
    ...
    setTimeout(() => this._mainLoop(), this.#timeout);
  }
...
export function startBurstStacks() {
  burstStacksStarted = true;
  burstStack10.start();
}

export function stopBurstStacks() {
...
export class CompRettyCompetition {
  ...
  constructor(name, description = '', imageURL = '', shuffleEnabled = true, competitionRole = null, teams = null, shuffle = null, competitionMessageID = null) {
  ...
  static withREST(rest, name, description = '', imageURL = '', shuffleEnabled = true, competitionRole = null, teams = null, shuffle = null, competitionMessageID = null) {
    if (teams == null) teams = CompRettyTeams.withREST(rest);
    var _competition = new CompRettyCompetition(name, description, imageURL, shuffleEnabled, competitionRole, teams, shuffle, competitionMessageID);
  ...
  static fromJSON(json, rest = null) {
    ...
    _competition = CompRettyCompetition.withREST(rest, json.name, json.description, json.imageURL, json.shuffleEnabled, json.competitionRole, _teams, _shuffle, json.competitionMessageID);
    return _competition;
  }
