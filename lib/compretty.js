...
export class CompRettyCompetition {
  ...
  execute(interaction, isAdmin = false) {
    ...
    if (_arg1 == 'teams') this.#teams.execute(interaction, isAdmin);
  }
...
export class CompRettyChannel {  
  ...
  _clearPlayersExecute(interaction, isAdmin = false) {
    if (!isAdmin) return this.sendPermissionDenied(interaction);
  ...
  execute(interaction, isAdmin = false) {
    ...
    switch (_arg1) {
      case 'clear_players': return this._clearPlayersExecute(interaction, isAdmin);
    }
